...
1) Download the whole project and load it in your Eclipse+Atelier IDE
2) Download the XML file attached with the last release, and from the terminal, once you're in the right namespace, execute:
```javascript
 do $system.OBJ.Load("<replace this with the full path to your XML file>","ck")
```
